...
Transaction is a message pack fixmap (named transaction container, first byte 0x80 - 0x8f) with
...
Field "ver" must be an integer, which indicates version of transaction to
...
Money transfer and smartcontract calling transactions must contains the following
fields
 ...
 - "t" (timestamp) - tx unixtime in milliseconds, positive integer exactly as seq,
...
unpacking of this tx will give (all binary data are encoded in base64)
