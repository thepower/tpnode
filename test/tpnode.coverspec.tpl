...
%{incl_app, [tpnode]}.
{incl_mods, [address,address_db,apixiom,base58,beacon,bin2hex,block,blockchain,
 blockchain_reader,blockchain_sync,blockchain_updater,blockvote,bron_kerbosch,
 bsig,chainkeeper,chainsettings,contract_evm,
 contract_wasm,discovery,generate_block,generate_block_process,
 genesis,genesis_easy,genuml,hashqueue,hex,httpapi_playground,
 interconnect,ldb,ledger_sync,maphash,mbal,mkblock,
 mkblock_genblk,mledger,naddress,nodekey,rdb_dispatcher,
 ...
 txpool,txqueue,txstatus,utils,vm,vm_wasm,xchain,xchain_api,
