...
evm_call_with_callcode_test() ->
      OurChain=151,
      Pvt1= <<194, 124, 65, 109, 233, 236, 108, 24, 50, 151, 189, 216, 23, 42, 215, 220, 24, 240,
              248, 115, 150, 54, 239, 58, 218, 221, 145, 246, 158, 15, 210, 165>>,
      Addr1=naddress:construct_public(1, OurChain, 1),
      Addr2=naddress:construct_public(1, OurChain, 10),
      ...
      {ok,_Log,#{bals:=B,txs:=[_],receipt:=[_Tx]}}=extcontract_template(OurChain, TxList1, Ledger, TestFun),
      [
...
%               ,{<<"tx2">>, maps:put(sigverify,#{valid=>1},TX2)}
      ...
      {ok,_Log,#{bals:=B0,txs:=_Tx,receipt:=Rec},_State2}=extcontract_template(OurChain, TxList1, Ledger, TestFun),
