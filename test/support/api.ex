defmodule TPHelpers.API do
  ...
  def api_get_tx_status(tx_id), do: api_get_tx_status(tx_id, Resolver.get_base_url())
  ...
  def api_post_transaction(transaction) do
    api_post_transaction(transaction, Resolver.get_base_url())
  end
  ...
  def api_get_wallet_seq(wallet) do
    api_get_wallet_seq(wallet, Resolver.get_base_url())
  end

  def api_get_wallet_seq(wallet, base_url), do: :tpapi.get_wallet_seq(wallet, base_url)

  # get the blockchain height
  def api_get_height() do
    api_get_height(Resolver.get_base_url())
  end
  ...
  def api_get_block_info(hash, opts \\ []) do
    :tpapi.get_blockinfo(hash, Resolver.get_base_url(Keyword.get(opts, :node, nil)))
  end
end
